...
def test_get_featurized_data():
    ...
    test_list.append(isinstance(dataset_obj_from_file.dataset, dc.data.datasets.DiskDataset.from_numpy)) 
...
def test_get_featurized_data_scaffold():
    ...
    test_list.append(isinstance(dataset_obj_from_file_scaffold.dataset, dc.data.datasets.DiskDataset.from_numpy))
